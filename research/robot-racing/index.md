    ...
    <div class="research-layout">
      ...
      <div class="research-content">
        ...
        <div id="robot-racing" class="research-content-section">
          <!-- Language Tabs -->
          <div class="language-tabs">
            <input type="radio" id="robot-racing-lang-ko" name="robot-racing-language" value="ko" checked>
            <label for="robot-racing-lang-ko" class="lang-tab">한국어</label>
            <input type="radio" id="robot-racing-lang-en" name="robot-racing-language" value="en">
            <label for="robot-racing-lang-en" class="lang-tab">English</label>
          </div>

          <!-- Content Area -->
          <div id="robot-racing-content-area" class="content-area">
            <!-- Korean Content -->
            <div id="robot-racing-ko-content" class="lang-content" data-lang="ko" style="display: block;">
            ...
            <!-- English Content -->
            <div id="robot-racing-en-content" class="lang-content" data-lang="en" style="display: none;">
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Language tab switching for RoboRacer section
  const robotRacingLangRadios = document.querySelectorAll('input[name="robot-racing-language"]');
  const robotRacingKoContent = document.getElementById('robot-racing-ko-content');
  const robotRacingEnContent = document.getElementById('robot-racing-en-content');

  robotRacingLangRadios.forEach(radio => {
    radio.addEventListener('change', function() {
      if (this.value === 'ko') {
        robotRacingKoContent.style.display = 'block';
        robotRacingEnContent.style.display = 'none';
      } else if (this.value === 'en') {
        robotRacingKoContent.style.display = 'none';
        robotRacingEnContent.style.display = 'block';
      }
    });
  });
});
